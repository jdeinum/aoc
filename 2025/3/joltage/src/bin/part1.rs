...
fn part1(joltages: &str) -> Result<u64> {
...
fn main() -> Result<()> {
    ...
    let res = part1(&s).context("run part 1")?;
...
234234234234278
818181911112111";
        assert_eq!(part1(input).context("part1")?, 357);
        Ok(())
    }
}
